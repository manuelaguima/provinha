...
CREATE TABLE `emprestimos` (
  ...
  KEY `idAluno` (`idAluno`),
  KEY `idLivro` (`idLivro`),
  CONSTRAINT `emprestimos_ibfk_1` FOREIGN KEY (`idAluno`) REFERENCES `alunos` (`codAluno`),
  CONSTRAINT `emprestimos_ibfk_2` FOREIGN KEY (`idLivro`) REFERENCES `livros` (`codLivro`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-08-11 16:02:50
